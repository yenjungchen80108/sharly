...
const classes = {
  ...
  tableRow: "text-sm text-gray-900 font-light px-6 py-4 whitespace-pre-wrap",
  ...
  searchIconOuter:
    "flex absolute inset-y-0 left-0 items-center pt-4 pl-3 pointer-events-none",
  searchInput:
    "block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-black",
      ...
      <div className="flex flex-col">
        <div className={classes.cardMargin}>
          <div className={classes.cardPadding}>
                ...
                {rows.map((row, i) => {
                  ...
                  return (
                    <tr {...row.getRowProps()} key={i} className="border-b">
                      ...
                      <td>
                        <button
                          className={classes.iconTableRow}
            ...
            >
              <Button onClick={handlePrev} disabled={pageIndex === 1}>
                <LeftArrow />
              </Button>
              &nbsp;
              <Button onClick={handleNext} disabled={pageIndex === pageCount}>
                <RightArrow />
              </Button>
            </div>
          </div>
        ...
        {openAdd ? (
          <AddDialog name={name} onClose={handleClose} onSubmit={onSubmit}>
            {children}
          </AddDialog>
        ) : (
          <></>
        ...
        {openEdit ? (
          <EditDialog name={name} onClose={handleClose} onSubmit={onSubmit}>
            {children}
          </EditDialog>
        ) : (
          <></>
