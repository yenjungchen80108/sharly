        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden md:flex space-x-10">
              ...
              <Link href="/add-post" className="text-base font-medium text-gray-500 hover:text-gray-900">{t('NAV.CONTACT')}</Link>
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <Link href="/login"><a className="text-base font-medium text-gray-500 hover:text-gray-900">
                {t('NAV.SIGN_IN')}</a></Link>
              <Link href="/register">
