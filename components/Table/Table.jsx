...
const TableList = ({ className, repos }) => {
  ...
  const onPageChanged = () => {
    // data.preventDefault();
    try {
      // const { currentPage, totalPages, pageLimit, repos } = data;
      // console.log('test',currentPage, totalPages, pageLimit, repos); // 1 2 5
      ...
      console.log('test',currentPage, totalPages, pageLimit, currentRepo);
    } catch (data) {
